...
public interface Traversable extends Printable {
     ...
     *                                       parent refuses to let it go. For
     *                                       instance, a BinaryExpression
     *                                       may refuse to remove its left side
     *                                       expression because that
     *                                       would lead to invalid IR. The only way
     *                                       to change a child of such
     ...
     *                                  violate a class invariant by becoming the
     *                                  <var>index</var><i>th</i>
     *                                  child.
     */
     ...
     *                                  would violate a class invariant. Not all
     *                                  classes perform this check
     *                                  because, for example, Expressions can appear
     *                                  as children of so many
