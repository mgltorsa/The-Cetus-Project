...
case "$1" in
  ...
  [ -d class ] || mkdir class
  javac -g -cp $PWD/lib/solr-solrj-9.2.0.jar:$PWD/lib/junit.jar:$PWD/lib/rsyntaxtextarea.jar:C:/Users/Migue/.ivy2/cache/org.apache.solr/solr-solrj/jars/solr-solrj-9.2.0.jar:$ANTLR:class -d class $SRC
  ;;
  jar)
  $0 compile
